...
- Final tracked-only checkout verification at commit `6263b95fe907076053aac362212f4175b340b303` passes both production CLIs: body/head checks 100 sources, `8/8/4` review cells, 20 approvals, zero diagnostics; limbs checks 100 sources, `24/24/12` review cells, 60 approvals with full live reconstruction, zero diagnostics. The Windows checkout retains canonical evidence/catalog/renderer bytes through exact `-text` attributes. The final single-worker suite passes `77/77` files, `631` tests with `2` skipped in `514.69s`; typecheck and diff-check pass after the evidence-only report update.
