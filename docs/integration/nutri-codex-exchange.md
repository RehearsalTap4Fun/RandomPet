...
- 下一批美术，按我建议的顺序：**①补齐五条进化链 5 张**（不改 schema，10→15 阶）；**②涂鸦背景槽 3 张**（用户已定形态，需 schema 升版，15→18 阶，规格见 `docs/art/pixel-backdrop-batch/`）；③颜色轴（0 新图）。
