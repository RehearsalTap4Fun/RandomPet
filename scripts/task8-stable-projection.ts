...
const TASK8_MARKER_REPLACEMENTS: Record<string, Record<string, string>> = {
  ...
  'packages/renderer-canvas/src/render.ts': {
    ...
    'renderer-task10-interface-face-inside-check': '      if (metric.insideRatio < policy.faceInsideRatio) {\n',
    'renderer-task10-interface-face-inside-argument': "          'COMPOSITION_FACE_OUT_OF_ZONE', slotId, metric.insideRatio, policy.faceInsideRatio,\n",
